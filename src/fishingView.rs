...
pub fn animate_fishing_line(
    ...
    mut line: Query<
        ...
        (With<FishingLine>, Without<Rotatable>),
    >,
    mut power_bar: Query<
        (&mut PowerBar, &mut Transform),
        (
            With<PowerBar>,
            Without<Rotatable>,
            Without<FishingLine>,
    ...
    >,
    mut splash: Query<
        (&mut Splash, &mut TextureAtlas, &mut Visibility),
        (With<Splash>, Without<FishingLine>, Without<Rotatable>),
    >,
    mut bobber: Query<
        (&mut Bobber, &mut Transform, &mut Visibility),
        (
            With<Bobber>,
            Without<Wave>,
            Without<Splash>,
    ...
    *bobber_visibility = Visibility::Visible;
    ...
    // Draw fishing line
    line_transform.translation = Vec3::new(line_pos.x, line_pos.y, 902.);
